      ...
      <div className="max-w-2xl mx-auto pt-8">
        <div className="flex items-center gap-4 mb-8">
          <button
            ...
            className="p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border bborder-gray-700"
          >
                  ...
                  <form onSubmit={submitHandler} className="space-y-4">
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder:gray-400"
                      />
