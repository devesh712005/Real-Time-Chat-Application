        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-center in-checked:space-x-3 gap-1">
                {otp.map((digit, index) => (
                  <input
                    key={index}
          ...
          <div className="mt-6 text-center ">
            ...
            {timer > 0 ? (
              <p className="text-gray-400 text-sm">Resend code in {timer}</p>
            ) : (
              <button
                className="text-blue-400 hover:blue-300 font-medium text-sm desabled:opacity-50"
